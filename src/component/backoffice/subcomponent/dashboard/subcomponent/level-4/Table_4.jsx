        ...
        if(this.props.data.length === 0) {
            return (
                <div className="table-alt-content margin-top">
                    <h2 className="table-alt-title">Ultimas ganancias nivel 4</h2>
        ...
        if(this.props.data) {
            ...
            return (
                <div className="table-alt-content margin-top">
                    ...
                    <Link to="/backoffice/level4" className="table-alt-showmore"> Mostrar mas <i className="fas fa-sort-down"></i></Link>
                </div>
            )
        }
    }
